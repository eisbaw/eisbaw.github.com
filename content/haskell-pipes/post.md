...
line without altering the first steps. Since `$` is just <span class="gloss" tabindex="0">syntax-sugar<span class="gloss-card"><span class="gc-head"><span class="gc-name">Syntactic sugar</span></span><span class="gc-body">Notation that is easier to read or write but adds no new capability to the language.</span></span></span> for
